...
from modules.bids_bookings.modules import CreateBidRequest, BidResponse # Make sure this import path matches your project!
...
async def place_bid(
    ...
    async with conn.cursor() as cur:
        ...
        try:
            ...
            # FIXED: Dictionary access instead of [0]
...
async def accept_bid(
    ...
    async with conn.cursor() as cur:
        ...
        # FIXED: Removed tuple unpacking, replaced with strict dictionary access
        job_id = row["job_id"]
        worker_id = row["worker_id"]
...
# TO DO: Endpoint 2 currently not working as worker_profile needs to be modified 